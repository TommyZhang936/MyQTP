...
void Dialog::onWeather(const QStringList &strList)
{
    ...
    ui->labelImage5->setPixmap(QPixmap(strImage + strList[20]));
    ui->labelImage6->setPixmap(QPixmap(strImage + strList[21]));
    ui->labelTemperature_3->setText(strList[17]);
    ui->labelWeather_3->setText(strList[18]);
    ui->labelWind_3->setText(strList[19]);
...
void Dialog::showClear()
{
    ...
    ui->labelImage6->clear();
    ui->labelTemperature_3->clear();
    ui->labelWeather_3->clear();
    ui->labelWind_3->clear();
}
