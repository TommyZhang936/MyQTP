#ifndef PYSLIDEBUTTON_H
#define PYSLIDEBUTTON_H
...
class PYSlideButton : public QWidget
{
    Q_OBJECT

public:
    PYSlideButton(QWidget *parent = 0);
    ~PYSlideButton();
